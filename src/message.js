/* 
THIS IS COPY & PASTED FROM https://github.com/bitpay/bitcore-message/blob/master/lib/message.js
Using bit-message with bitcore-lib is a long-reported problem and no maintainers are fixing it
https://github.com/bitpay/bitcore-message/issues/29
 */
